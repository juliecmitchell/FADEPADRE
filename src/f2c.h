...
#ifdef __cplusplus						/* Need to force ANSI C library access */			
#define CPLUSPLUS_SET __cplusplus		/* Otherwise math.h and Mac F2C code have clashing math function protos */
#undef __cplusplus
#endif	/* C++ */

#include <math.h>						/* Need to include this for MWERKS */

#ifdef CPLUSPLUS_SET
#define __cplusplus CPLUSPLUS_SET
#undef CPLUSPLUS_SET
#endif /* Restore C++ */
...
#endif  /* prototypes for ANSI C and C++ */
